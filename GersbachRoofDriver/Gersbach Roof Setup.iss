...
; Generated by Nicholas Dahlke on 01.08.2022 (UTC)
;
[Setup]
AppID={{e5692828-8f01-44dc-aaa4-fa53f3620610}
AppName=ASCOM Gersbach Roof Dome Driver
AppVerName=ASCOM Gersbach Roof Dome Driver 6.0.0
AppVersion=6.0.0
AppPublisher=Nicholas Dahlke <nicholas.dahlke@gmx.de>
AppPublisherURL=mailto:nicholas.dahlke@gmx.de
...
OutputDir="."
OutputBaseFilename="Gersbach Roof Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\Dome\Gersbach Roof"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\Dome\Gersbach Roof"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]
Source: "C:\Users\Nicholas Dahlke\source\repos\GersbachRoofDriver\GersbachRoofDriver\bin\Release\ASCOM.GersbachRoof.Dome.dll"; DestDir: "{app}"
; Require a read-me HTML to appear after installation, maybe driver's Help doc
Source: "C:\Users\Nicholas Dahlke\source\repos\GersbachRoofDriver\GersbachRoofDriver\README.txt"; DestDir: "{app}"; Flags: isreadme
...
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.GersbachRoof.Dome.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.GersbachRoof.Dome.dll"""; Flags: runhidden 64bit; Check: IsWin64
...
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.GersbachRoof.Dome.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.GersbachRoof.Dome.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.GersbachRoof.Dome.dll"""; Flags: runhidden 64bit; Check: IsWin64
